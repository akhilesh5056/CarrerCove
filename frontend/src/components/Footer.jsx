...
const Footer = () => {
    return (
        <footer className="bg-gray-100 py-6 border-t border-gray-300 flex max-w-7xl">
            <div className="container mx-auto px-4 flex items-center justify-between max-w-6xl">
                <div>
                    <p className="text-2xl font-bold text-gray-800">Job Nexus</p>
                    <p className="text-sm text-gray-500 mt-1">© 2024 Your Company. All rights reserved.</p>
                </div>
